...
<body id="page-top">
 ...
 #accordionSidebar {
  ...
  background-color: #343a40; /* Set your desired background color *//* Add scrollbars if content overflows */
...
<div id="map" class="map-overlay">
  ...
  <p id="sidebar-duedate"></p>
      ...
      <form action="uploadimage.php" method="post" enctype="multipart/form-data" id="upload-form">
          ...
          <button type="button" id="upload-btn" class="btn btn-secondary">Upload Photo</button>
      </form>
      <br>
...
if ('<?php echo $grave20 && $grave20["name"] === "Grave is Available" ? "true" : "false"; ?>' === 'true') {
  grave20.setIcon(availableIcon);
    ...
    // grave1.bindPopup('<div style="text-align: center; font-weight: bold; font-size: 25px;">' + 'Grave 1' + '</div><img src="../../<?php echo $grave1["imagepath"]?>" alt="Grave 1" width="200">');
    // grave2.bindPopup('<div style="text-align: center; font-weight: bold; font-size: 25px;">' + 'Grave 2' + '</div><img src="../../<?php echo $grave2["imagepath"]?>" alt="Grave 1" width="200">');
    // grave3.bindPopup('<div style="text-align: center; font-weight: bold; font-size: 25px;">' + 'Grave 3' + '</div><img src="../../<?php echo $grave3["imagepath"]?>" alt="Grave 1" width="200">');
    // grave4.bindPopup('<div style="text-align: center; font-weight: bold; font-size: 25px;">' + 'Grave 4' + '</div><img src="../../<?php echo $grave4["imagepath"]?>" alt="Grave 1" width="200">');
    // grave5.bindPopup('<div style="text-align: center; font-weight: bold; font-size: 25px;">' + 'Grave 5' + '</div><img src="../../<?php echo $grave5["imagepath"]?>" alt="Grave 1" width="200">');
    // grave6.bindPopup('<div style="text-align: center; font-weight: bold; font-size: 25px;">' + 'Grave 6' + '</div><img src="../../<?php echo $grave6["imagepath"]?>" alt="Grave 1" width="200">');
    // grave7.bindPopup('<div style="text-align: center; font-weight: bold; font-size: 25px;">' + 'Grave 7' + '</div><img src="../../<?php echo $grave7["imagepath"]?>" alt="Grave 1" width="200">');
    // grave8.bindPopup('<div style="text-align: center; font-weight: bold; font-size: 25px;">' + 'Grave 8' + '</div><img src="../../<?php echo $grave8["imagepath"]?>" alt="Grave 1" width="200">');
    // grave9.bindPopup('<div style="text-align: center; font-weight: bold; font-size: 25px;">' + 'Grave 9' + '</div><img src="../../<?php echo $grave9["imagepath"]?>" alt="Grave 1" width="200">');
...
bindPopupOnHover(grave20, '<div style="text-align: center; font-weight: bold; font-size: 25px;">Grave 20</div><img src="../../<?php echo $grave20["imagepath"]?>" alt="Grave 20" width="200">');
  ...
  document.getElementById('fileToUpload').addEventListener('change', function() {
      // Get the grave ID
      var graveId = document.getElementById('graveId').value;
      
      // Append the grave ID to the form action URL
      var formAction = document.getElementById('upload-form').action;
      document.getElementById('upload-form').action = formAction + '?grave=' + graveId;
  ...
  function openSidebar(title, dateofbirth,dateofdeath,rentdate,duedate, marker, imagePath, graveId) {
      ...
      // sidebarGraveno.textContent = graveno;
